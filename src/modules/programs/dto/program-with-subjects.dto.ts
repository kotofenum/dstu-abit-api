...
import { ProgramSubjectDto } from "src/modules/program-subjects/dto/program-subject.dto";
import { SpecialtyDto } from "src/modules/specialties/dto/specialty.dto";
import { ProgramDegree } from "../entities/program.entity";

@ObjectType()
export class ProgramWithSubjectsDto {
  @Field()
  readonly uid: string;
  ...
  @Field(() => [ProgramSubjectDto])
  readonly subjects: ProgramSubjectDto[];
}
